...
class PartitionManager {
    ...
    set data (d) {
        this.items = (d.items || []).map(item => {
            ...
            // migration boolean → integer pour les patterns sauvegardés avant v1.9.5.4
    ...
    onProgress ( xhr ) {
        if ( xhr.lengthComputable ) {
            ...
            if (percentComplete < 100) {
                ...
                elem.innerHTML = '<i class="icon-sliders"></i> Guitar Lab <span class="app-version">1.9.5.4</span>';
            }
        }
    }
    onError ( xhr ) {
...
class Application {
  constructor (onReady = () => {}, guitardef = null) {
        ...
        this.appstamp.innerHTML = '<i class="icon-sliders"></i> Guitar Lab <span class="app-version">1.9.5.4</span>';
