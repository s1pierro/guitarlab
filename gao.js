    ...
    onProgress ( xhr ) {
        if ( xhr.lengthComputable ) {
            ...
            if (percentComplete < 100) {
                ...
                elem.innerHTML = '<i class="icon-sliders"></i> Guitar Lab <span class="app-version">1.9.1.3</span>';
            }
        }
    }
    onError ( xhr ) {
...
class Application {
  constructor (onReady = () => {}) {
        ...
        this.appstamp.innerHTML = '<i class="icon-sliders"></i> Guitar Lab <span class="app-version">1.9.1.3</span>';
